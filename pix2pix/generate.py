...
def generate_images(model, test_input, tar, num):
    ...
    for i in range(3):
        ...
        plt.axis('off')
    resultFig.savefig(PATH + 'result/result' + str(num) + '.png')

checkpoint.restore(tf.train.latest_checkpoint(checkpoint_dir))
for num, img in enumerate(test_dataset.take(50)):
    generate_images(generator, img[0], img[1], num)